G={'Habib University': [('Hash Food Johar Branch', 0.6609850990610772), ('Sunbeam Apartment', 0.06911255833382617)], 'Hash Food Johar Branch': [('Bank Alfalah', 0.5017723050574527)], 'Bank Alfalah': [('Chase Up Flagship Store Johar', 0.15023365310825085)], 'Chase Up Flagship Store Johar': [('Digital Door Intersection', 0.10964877260583718)], 'Digital Door Intersection': [('MCB Bank', 0.04468969559664938), ('Johar Sweets', 1.3547604502934434)], 'MCB Bank': [('Darul Sehat Hospital', 0.16630838121157718)], 'Darul Sehat Hospital': [], 'Sunbeam Apartment': [('Quetta Khyber Hotel', 0.05947531934245447), ('Mideast Dental Clinic', 0.09197023442076015), ('My Hospital', 0.2975017566111297), ('M.J Memorial Hospital', 0.4420275298684055)], 'Quetta Khyber Hotel': [('Little Folks School', 0.34080758981751424)], 'Little Folks School': [('Everest Coaching Center', 0.5105021472345388)], 'Everest Coaching Center': [('Rado Sweets & Bakers', 0.1836611966290906)], 'Rado Sweets & Bakers': [('MZ clothing', 0.1666494715209726)], 'MZ clothing': [('Flower Shop', 0.01097017621128319)], 'Flower Shop': [('Turning1', 0.059913568166984225)], 'Turning1': [('Turning2', 0.02237703849962231)], 'Turning2': [('Frenchies fries stall', 0.055299121258588525)], 'Frenchies fries stall': [('Turning3', 0.06877677754700344)], 'Turning3': [('Darul Sehat Hospital', 0.025455539994832015)], 'Johar Sweets': [('Point1', 0.3268718150039939)], 'Point1': [('Turning4', 0.017398685363761962)], 'Turning4': [('Millennium Bus Stop', 0.06521655634092359)], 'Millennium Bus Stop': [('Super salateen restaurant', 0.4504830193735977)], 'Super salateen restaurant': [('Abu Bakar Masjid', 0.5380321155199186)], 'Abu Bakar Masjid': [('Al-Shifa Homeo Clinic & Store', 0.19760785412733806)], 'Al-Shifa Homeo Clinic & Store': [('Fashion Communication', 1.531262270806388)], 'Fashion Communication': [('Baghpatee Group Of Companies', 1.2107075401117307)], 'Baghpatee Group Of Companies': [('Turning5', 0.7832016106506691), ('Turning10', 0.35748045036575654)], 'Turning5': [('Turning6', 0.00704854871875399)], 'Turning6': [('Turning7', 0.15153643614200582), ('Turning8', 0.8258802567376626)], 'Turning7': [('Agha Khan Hospital', 0.0352129306098678)], 'Agha Khan Hospital': [], 'Turning8': [('Turning9', 0.008944068080015912)], 'Turning9': [('Liaquat National Hospital', 0.16269642039820453)], 'Liaquat National Hospital': [], 'Turning10': [('Dhoraji Chowrangi', 0.14920753371242704)], 'Dhoraji Chowrangi': [('Jamal Noor Hospital', 0.1893196062329681), ('MMQ DIAGNOSTIC AND MEDICAL CENTRE', 0.17775738380364378), ('Dr mashood hamid khan doraji', 0.20008022060317168), ('Dr Abdul Hameed Diagnostic and Medical Center', 0.2083486525257904)], 'Jamal Noor Hospital': [], 'MMQ DIAGNOSTIC AND MEDICAL CENTRE': [], 'Dr mashood hamid khan doraji': [], 'Dr Abdul Hameed Diagnostic and Medical Center': [], 'Mideast Dental Clinic': [], 'My Hospital': [], 'M.J Memorial Hospital': []}
...
def generate_hospital_dict(value):
    ...
    if value == 'Toothache':
        hospital_info_update = hospital_info
...
#create an edge from user location to closest node in G
def create_user_edge(loc_user):
    nearest = nearest_node(loc_user, nodes_coord)

    key = nearest[0] #nearest = name, coordinate
    sourcex = 'Loc User'
    G[sourcex] = [(nearest[0], int(nearest[1]))]
    for i in G:
        if i==key:
            valuexx = [sourcex, nearest[1]]
            G[key].append(tuple(valuexx))
